...
with features:
    ...
    area_sel, disp_col = sel_col.slider("area",min_value=810,max_value=2080,value=1302,step=1)
    latitude_sel, disp_col = sel_col.slider("latitude",min_value=28.24,max_value=28.79,value=28.56,step=0.01)
    longitude_sel, disp_col = sel_col.slider("longitude",min_value=76.88,max_value=77.56,value=77.29,step=0.01)
    Bedrooms_sel, disp_col = sel_col.slider("Bedrooms",min_value=2,max_value=10,value=3,step=1)
